...
public class designRuntimes {
	public static void main(String[] args) {
		...
		try {
			...
			FileWriter writer = new FileWriter(Const.ID_BASE + "designtimes-sync.csv");
...
//									}
							...
							case 3:
								...
								for (ObjectId objectId : l) {
									synchronized (designRuntimes.class) {
...
//									}
							...
							case 2:
								...
								for (DBObject dbObject : o) {
//									String x = (String)
//									DBObject x = dbObject;// .get("B_NAME");
									System.out.println(dbObject.get("B_NAME"));
								}
								break;
							case 3:
							...
							buffer.write(i + "," + z + "," + String.valueOf(System.nanoTime() - start) + "\n");
						}
...
//								DBObject x = m.next();// .get("B_NAME");
							...
							case 2: // books by author
								...
								for (DBObject dbObject : q) {
//									String x = (String)
//									DBObject x1 = dbObject;// .get("B_NAME");
									System.out.println(dbObject.get("B_NAME"));
								}
